...
PORTFOLIO_IMPROVEMENT_REPORTS_INDEX_BODY = {
    ...
    "mappings": {
        ...
        "properties": {
            ...
            "horizons": {"type": "keyword"},
            "source_evaluation_summary": {"type": "object", "enabled": False},
            "pattern_summary": {"type": "object", "enabled": False},
            "improvement_candidates": {"type": "object", "enabled": False},
            "recommendation_summary": {"type": "text"},
...
class PortfolioImprovementRepository:
    def __init__(self, es_client: ElasticsearchClient, settings: Settings) -> None:
        ...
        self.index_name = settings.es_portfolio_improvement_reports_index

    def ensure_index(self) -> None:
        self.es_client.create_index_if_missing(self.index_name, PORTFOLIO_IMPROVEMENT_REPORTS_INDEX_BODY)
